...
public class BookQueryRepository {
	...
	public SliceImpl<BookSimpleResponse> getAllDibsBook(Long memberId,
		...
		List<BookSimpleResponse> result = jpaQueryFactory.select(
				new QBookSimpleResponse(dibs.book.id, dibs.book.title, dibs.book.bookState, dibs.book.ImgUrl, dibs.book.rentalFee, dibs.book.location, dibs.book.member.nickname))
			.from(dibs)
			.leftJoin(dibs.book)
